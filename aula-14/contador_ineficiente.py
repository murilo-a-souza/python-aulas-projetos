...
if salario_0 < media:
    print(f'Salário abaixo da média: R${salario_0:.2f}')
if salario_1 < media:
    print(f'Salário abaixo da média: R${salario_1:.2f}')
if salario_2 < media:
    print(f'Salário abaixo da média: R${salario_2:.2f}')
if salario_3 < media:
    print(f'Salário abaixo da média: R${salario_3:.2f}')