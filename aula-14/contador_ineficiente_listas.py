...
if salarios[0] < media:
    print(f'Salário abaixo da média: R${salarios[0]:.2f}')
if salarios[1] < media:
    print(f'Salário abaixo da média: R${salarios[1]:.2f}')
if salarios[2] < media:
    print(f'Salário abaixo da média: R${salarios[2]:.2f}')
if salarios[3] < media:
    print(f'Salário abaixo da média: R${salarios[3]:.2f}')